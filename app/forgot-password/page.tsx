      ...
      <div className="w-full lg:w-1/2 bg-black flex items-center justify-center p-8">
        <div className="w-full max-w-[582px] space-y-8">
          ...
          <div className="text-center space-y-2 mb-29">
            <h1 className="text-3xl md:text-4xl font-joker text-white tracking-wider font-card">
              reset your
              <br />
              password
            </h1>
          ...
          <div className="space-y-6 mt-6">
            ...
            {/* Get OTP Button */}
            <button className="w-full bg-white text-black hover:bg-gray-100 font-roboto font-semibold text-lg h-12 rounded-md transition-colors">
            <Link href="/otp" />
              Get OTP
            </button>
            ...
            <p className="text-center font-roboto text-white text-sm">
              ...
              <Link href="/register" className="text-red-500 hover:text-red-400 font-roboto font-semibold">
                Sign up
              </Link>
            </p>
          </div>
