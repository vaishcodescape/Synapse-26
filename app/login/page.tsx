          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div>
              <input
                ...
                className="w-full px-4 py-3.5 bg-transparent border border-white rounded-md text-white placeholder:text-white/40 focus:outline-none focus:border-white transition-all text-base font-roboto"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full bg-white text-black py-3.5 rounded-md font-roboto font-semibold hover:bg-white/90 transition-colors text-base mt-2"
            >
              Continue
            </button>
            ...
            <p className="text-center text-white/70 text-base mt-4">
              ...
              <Link href="/register" className="text-[#dc2626] hover:underline font-roboto font-medium">
                Sign up
              </Link>
            </p>
          </form>
