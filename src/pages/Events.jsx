...
const Events = () => {
  ...
  const getEnabledCategories = (participationCategories) => {
    const enabled = [];
    ...
    if (participationCategories.group.enabled) 
      enabled.push(`Group ${participationCategories.group.minParticipants}-${participationCategories.group.maxParticipants} (₹${participationCategories.group.fee} fixed)`);
            ...
            <tbody className="divide-y divide-gray-200">
              {events.map((event) => (
                <tr key={event.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-900">
                    {getEnabledCategories(event.participationCategories)}
                  </td>
                  <td className="px-6 py-4 text-sm">
            ...
            <form onSubmit={handleEditSave} className="p-6 space-y-4">
              ...
              <div className="border rounded-lg p-4 bg-gray-50">
                ...
                <div className="flex items-center gap-4 mb-3 pb-3 border-b">
                  ...
                  />
                  <label htmlFor="solo" className="text-sm font-medium text-gray-700 w-32">
                    Solo (1 person)
                  </label>
                ...
                <div className="flex items-center gap-4 mb-3 pb-3 border-b">
                  <input
                    ...
                    className="w-4 h-4 text-indigo-600"
                  />
                  <label htmlFor="duet" className="text-sm font-medium text-gray-700 w-32">
                    Duet (2 persons)
                  </label>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <label htmlFor="group" className="text-sm font-medium text-gray-700 block mb-2">
                      Team (Custom Range)
                    </label>
                    {editingEvent.participationCategories.group.enabled && (
                      <div className="bg-white border rounded-lg p-3 space-y-3">
                        <div className="grid grid-cols-2 gap-3">
                          <div>
                            <label className="text-xs text-gray-600 block mb-1">Min Participants</label>
                            <input
                              type="number"
                          ...
                          <div>
                            <label className="text-xs text-gray-600 block mb-1">Max Participants</label>
                            <input
                              type="number"
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-sm text-gray-600">Fixed Team Fee:</span>
                          <input
                            type="number"
                        ...
                        <p className="text-xs text-gray-500 italic">
                          Dropdown will show {editingEvent.participationCategories.group.minParticipants} to {editingEvent.participationCategories.group.maxParticipants} participants. 
                          <strong>Fee is FIXED regardless of team size.</strong>
                        </p>
                        <p className="text-xs text-green-600">
                          Example: Team of {editingEvent.participationCategories.group.minParticipants}-{editingEvent.participationCategories.group.maxParticipants} = ₹{editingEvent.participationCategories.group.fee} (fixed)
                        </p>
                      </div>
                    )}
                  </div>
...
//         solo: { enabled: true, fee: 100 },
//         duet: { enabled: true, fee: 200 },
//         group: { enabled: false, feePerPerson: 100, minParticipants: 3, maxParticipants: 8 },
//       },
//     },
//     {
//       id: 2,
...
//         solo: { enabled: true, fee: 150 },
//         duet: { enabled: true, fee: 250 },
//         group: { enabled: true, feePerPerson: 120, minParticipants: 4, maxParticipants: 10 },
//       },
//     },
//   ]);
...
//           solo: { enabled: false, fee: 0 },
//           duet: { enabled: false, fee: 0 },
//           group: { enabled: false, feePerPerson: 0, minParticipants: 3, maxParticipants: 8 },
//         },
//       },
//     ]);
//     setFormData({
...
//   // Handle participation fee change
//   const handleParticipationFeeChange = (type, fee) => {
//     setEditingEvent((prev) => ({
//       ...prev,
//       participationCategories: {
...
//         [type]: {
//           ...prev.participationCategories[type],
//           [type === 'group' ? 'feePerPerson' : 'fee']: Number(fee),
//         },
//       },
//     }));
//   };
...
//       enabled.push(`Duet (₹${participationCategories.duet.fee})`);
//     if (participationCategories.group.enabled) 
//       enabled.push(`Group ${participationCategories.group.minParticipants}-${participationCategories.group.maxParticipants} (₹${participationCategories.group.feePerPerson}/person)`);
//     return enabled.length > 0 ? enabled.join(', ') : 'None';
//   };
...
//                 </h4>
//                 <p className="text-xs text-gray-500 mb-3">
//                   Select allowed participation types and set their registration fees.
//                 </p>
...
//                         </div>
//                         <div className="flex items-center gap-2">
//                           <span className="text-sm text-gray-600">Fee per person:</span>
//                           <input
//                             type="number"
//                             value={editingEvent.participationCategories.group.feePerPerson}
//                             onChange={(e) =>
//                               handleParticipationFeeChange('group', e.target.value)
//                             }
//                             className="w-24 px-3 py-1 border rounded-lg focus:ring-2 focus:ring-indigo-500"
...
//                         </div>
//                         <p className="text-xs text-gray-500 italic">
//                           Dropdown will show {editingEvent.participationCategories.group.minParticipants} to {editingEvent.participationCategories.group.maxParticipants} participants. Total fee = fee_per_person × selected_number
//                         </p>
//                         <p className="text-xs text-green-600">
//                           Example: ₹{editingEvent.participationCategories.group.feePerPerson} × {editingEvent.participationCategories.group.minParticipants} people = ₹{editingEvent.participationCategories.group.feePerPerson * editingEvent.participationCategories.group.minParticipants}
//                         </p>
//                       </div>
//                     )}
//                   </div>
...
// //   const getEnabledCategories = (participationCategories) => {
// //     const enabled = [];
// //     if (participationCategories.solo.enabled) enabled.push(`Solo (₹${participationCategories.solo.fee})`);
// //     if (participationCategories.duet.enabled) enabled.push(`Duet (₹${participationCategories.duet.fee})`);
// //     if (participationCategories.group.enabled) enabled.push(`Group (₹${participationCategories.group.fee})`);
// //     return enabled.length > 0 ? enabled.join(', ') : 'None';
// //   };
...
// //                 </h4>
// //                 <p className="text-xs text-gray-500 mb-3">
// //                   Select allowed participation types and set their registration fees. Users will see these options on the website.
// //                 </p>
...
// //                     className="w-4 h-4 text-indigo-600"
// //                   />
// //                   <label htmlFor="group" className="text-sm font-medium text-gray-700 w-32">
// //                     Group (3-8 persons)
// //                   </label>
// //                   {editingEvent.participationCategories.group.enabled && (
// //                     <div className="flex items-center gap-2">
...
// // // const Events = () => {
// // //   const [events, setEvents] = useState([
// // //     { id: 1, name: 'Hackathon 2025', category: 'Technical', date: '2025-12-20', rulebookLink: 'https://drive.google.com/...', imageUrl: '', registrationOpen: true },
// // //     { id: 2, name: 'Dance Battle', category: 'Cultural', date: '2025-12-21', rulebookLink: 'https://drive.google.com/...', imageUrl: '', registrationOpen: false },
// // //   ]);
...
// // //     } else {
// // //       // Add new event
// // //       setEvents([...events, { id: Date.now(), ...formData, imageUrl: '', registrationOpen: true }]);
// // //     }
// // //     setFormData({
// // //       name: '',
// // //       category: 'Technical',
...
// // //           </div>
// // //           <div>
// // //             <label className="block text-sm font-medium text-gray-700 mb-2">Event Picture</label>
// // //             <input
// // //               type="file"
// // //               accept="image/*"
// // //               className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500"
...
// // //           </div>
// // //           <div className="md:col-span-2">
// // //             <label className="block text-sm font-medium text-gray-700 mb-2">Rulebook Google Drive Link</label>
// // //             <input
// // //               type="url"
// // //               value={formData.rulebookLink}
...
// // //                 <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Rulebook</th>
...
// // //                       />
// // //                     </button>
// // //                     <span className={`ml-2 text-xs ${event.registrationOpen ? 'text-green-600' : 'text-gray-500'}`}>
// // //                       {event.registrationOpen ? 'Open' : 'Closed'}
// // //                     </span>
// // //                   </td>
// // //                   <td className="px-6 py-4 text-sm text-gray-900">{event.name}</td>
// // //                   <td className="px-6 py-4 text-sm text-gray-900">{event.category}</td>
...
// // // // const Events = () => {
// // // //   const [events, setEvents] = useState([
// // // //     { id: 1, name: 'Hackathon 2025', category: 'Technical', date: '2025-12-20', venue: 'Lab 1', maxParticipants: 100, fee: 200 },
// // // //     { id: 2, name: 'Dance Battle', category: 'Cultural', date: '2025-12-21', venue: 'Auditorium', maxParticipants: 50, fee: 100 },
// // // //   ]);
...
// // // //                   <td className="px-6 py-4 text-sm text-gray-500">{event.maxParticipants}</td>
// // // //                   <td className="px-6 py-4 text-sm text-gray-500">₹{event.fee}</td>
// // // //                   <td className="px-6 py-4 text-sm">
// // // //                     <button
// // // //                       onClick={() => handleDelete(event.id)}
// // // //                       className="text-red-600 hover:text-red-800"
